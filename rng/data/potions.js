...
const POTIONS = {
    luck_potion_1: {
        ...
        description: 'Gives a +50% Luck boost for 1 minute.',
        tier: 1,
    },
    luck_potion_2: {
        id: 'luck_potion_2',
        ...
        description: 'Gives a +150% Luck boost for 1.5 minutes. Crafted from 10x Luck Potion I.',
        tier: 2,
    },
    luck_potion_3: {
        id: 'luck_potion_3',
        ...
        category: 'stackable',
        durationMs: 120_000,
        effects: { luckBonus: 300 },
        description: 'Gives a +300% Luck boost for 2 minutes. Crafted from 100x Luck Potion II.',
        tier: 3,
    },
    ...
    fortune_potion_1: {
        ...
        category: 'stackable',
        durationMs: 5 * 60_000,
        effects: { luckBonus: 400 },
        description: 'Gives a +400% Luck boost for 5 minutes.',
    },
    haste_potion_1: {
        id: 'haste_potion_1',
        name: 'Haste Potion I',
    ...
    fortune_potion_2: {
        ...
        category: 'stackable',
        durationMs: 7 * 60_000,
        effects: { luckBonus: 600 },
        description: 'Gives a +600% Luck boost for 7 minutes.',
    },
    haste_potion_2: {
        id: 'haste_potion_2',
    ...
    fortune_potion_3: {
        ...
        effects: { luckBonus: 800 },
        description: 'Gives a +800% Luck boost for 10 minutes.',
    },
    haste_potion_3: {
        id: 'haste_potion_3',
    ...
    gladiator_potion: {
        ...
        effects: { luckBonus: 300 },
        description: 'Gives a +300% Luck boost for 15 minutes.',
    },
    hades_potion: {
        id: 'hades_potion',
        name: 'Hades Potion',
        ...
        effects: { luckBonus: 800, rollSpeedBonus: -10 },
        description: 'Gives +800% Luck and -10% Roll Speed for 4 hours.',
    },
    forbidden_potion_3: {
        ...
        effects: { luckBonus: 2000, rollSpeedBonus: 75 },
        description: 'Gives +2000% Luck and +75% Roll Speed for 3 hours.',
    },
    heavenly_potion: {
        id: 'heavenly_potion',
    ...
    godly_potion_zeus: {
        ...
        effects: { luckBonus: 1000, rollSpeedBonus: 50 },
    ...
    godly_potion_hades: {
        ...
        category: 'stackable',
        durationMs: 30 * 60_000,
        effects: { luckBonus: 1200, rollSpeedBonus: 30 },
    ...
    godly_potion_poseidon: {
        ...
        category: 'stackable',
        durationMs: 30 * 60_000,
        effects: { luckBonus: 1100, rollSpeedBonus: 40 },
    ...
    warp_potion: {
        ...
        effects: { luckBonus: 1500, rollSpeedBonus: 20 },
